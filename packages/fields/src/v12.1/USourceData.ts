 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/12.1.0/ucd/USourceData.txt#L12-L39
 *
 * @unicodeVersion 12.1
 * @fields 8
 * @confidence 1.00
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-28T04:47:30.261Z
 */
export interface USourceData {
  ...
  /**
   * Text indicating the ideograph's status (A=Encoded in Extension A, B=Encoded in Extension B, etc.; also UTC-##### or UCI-##### for duplicates)
   *
  ...
  /**
   * A Unicode code point; for status V specifies the encoded character for which this is a variant, otherwise the encoded character for this entry
   *
