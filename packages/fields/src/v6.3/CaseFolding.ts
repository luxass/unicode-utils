 ...
 * - https://ucdjs.dev/file-explorer/v/6.3.0/ucd/CaseFolding.txt#L37-L41
 *
 * @unicodeVersion 6.3
 * @fields 4
 * @confidence 0.90
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T18:51:56.868Z
 */
export interface CaseFolding {
   ...
   *
   * @source https://ucdjs.dev/file-explorer/v/6.3.0/ucd/CaseFolding.txt#L37-L41
   */
  status: "C" | "F" | "S" | "T";
