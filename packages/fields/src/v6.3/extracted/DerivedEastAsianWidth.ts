 ...
 * - https://ucdjs.dev/file-explorer/v/6.3.0/ucd/extracted/DerivedEastAsianWidth.txt#L20
 *
 * @unicodeVersion 6.3
 * @fields 2
 * @confidence 0.80
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-28T04:49:18.646Z
 */
export interface ExtractedDerivedEastAsianWidth {
   ...
   *
   * @source https://ucdjs.dev/file-explorer/v/6.3.0/ucd/extracted/DerivedEastAsianWidth.txt#L20
   */
