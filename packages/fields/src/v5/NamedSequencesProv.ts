 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/5.0.0/ucd/NamedSequencesProv.txt#L14-L15
 *
 * @unicodeVersion 5
 * @fields 2
 * @confidence 0.90
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-24T04:30:35.302Z
 */
export interface NamedSequencesProv {
  /**
   * Name of Sequence
   *
   * @source https://ucdjs.dev/file-explorer/v/5.0.0/ucd/NamedSequencesProv.txt#L14-L15
   */
  name: string;
