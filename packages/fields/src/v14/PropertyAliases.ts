 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/14.0.0/ucd/PropertyAliases.txt#L19-L30
 *
 * @unicodeVersion 14
 * @fields 3
 * @confidence 0.80
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-24T04:20:23.652Z
 */
export interface PropertyAliases {
   ...
   *
   * @source https://ucdjs.dev/file-explorer/v/14.0.0/ucd/PropertyAliases.txt#L19-L30
   */
  short_name: string;
