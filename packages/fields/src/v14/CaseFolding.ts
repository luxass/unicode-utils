 ...
 * - https://ucdjs.dev/file-explorer/v/14.0.0/ucd/CaseFolding.txt#L38-L44
 *
 * @unicodeVersion 14
 * @fields 4
 * @confidence 0.90
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-24T04:18:11.321Z
 */
export interface CaseFolding {
   ...
   *
   * @source https://ucdjs.dev/file-explorer/v/14.0.0/ucd/CaseFolding.txt#L38-L44
   */
  status: "C" | "F" | "S" | "T";
