 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/17.0.0/ucd/ArabicShaping.txt#L39-L46
 ...
 * @generated 2026-04-23T18:48:20.106Z
 */
export interface ArabicShaping {
  /**
   * The code point of a character, in hexadecimal form.
   *
   * @source https://ucdjs.dev/file-explorer/v/17.0.0/ucd/ArabicShaping.txt#L39-L40
   */
  code_point: string;
