 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/17.0.0/ucd/TangutSources.txt#L17-L22
 *
 * @unicodeVersion 17
 * @fields 3
 * @confidence 0.90
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-24T04:17:09.315Z
 */
export interface TangutSources {
  /**
   * the Tangut code point value in U+ format
   *
   * @source https://ucdjs.dev/file-explorer/v/17.0.0/ucd/TangutSources.txt#L17-L19
   */
  code_point: string;
   ...
   * the value (in UTF-8)
   *
   * @source https://ucdjs.dev/file-explorer/v/17.0.0/ucd/TangutSources.txt#L17-L22
   */
  value: string;
}
