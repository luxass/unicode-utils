 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/17.0.0/ucd/CJKRadicals.txt#L19-L26
 *
 * @unicodeVersion 17
 * @fields 3
 * @confidence 0.80
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T18:48:12.050Z
 */
export interface CjkRadicals {
  /**
   * The CJK radical number matching the regular expression [1-9][0-9]{0,2}'{0,3}.
   *
   * @source https://ucdjs.dev/file-explorer/v/17.0.0/ucd/CJKRadicals.txt#L19-L26
   */
   ...
   *
   * @source https://ucdjs.dev/file-explorer/v/17.0.0/ucd/CJKRadicals.txt#L20-L22
   */
   ...
   *
   * @source https://ucdjs.dev/file-explorer/v/17.0.0/ucd/CJKRadicals.txt#L23
   */
