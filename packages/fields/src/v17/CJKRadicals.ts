 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/17.0.0/ucd/CJKRadicals.txt#L19-L23
 *
 * @unicodeVersion 17
 * @fields 3
 * @confidence 1.00
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-28T04:39:25.708Z
 */
export interface CjkRadicals {
  /**
   * The CJK radical number.
   *
   * @source https://ucdjs.dev/file-explorer/v/17.0.0/ucd/CJKRadicals.txt#L19-L20
   */
