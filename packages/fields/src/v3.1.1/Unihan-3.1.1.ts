 ...
 * @generated 2026-04-23T18:55:50.190Z
 */
export interface Unihan311 {
   ...
   *
   * @source https://ucdjs.dev/file-explorer/v/3.1-Update1/Unihan-3.1.1.txt#L33-L34
   */
  tag: string;
...
export const UNIHAN_311_FIELDS = ["codepoint", "tag", "value"];
