 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/18.0.0/ucd/PropertyAliases.txt#L19-L30
 *
 * @unicodeVersion 18
 * @fields 3
 * @confidence 0.90
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-24T04:17:14.165Z
 */
export interface PropertyAliases {
   ...
   *
   * @source https://ucdjs.dev/file-explorer/v/18.0.0/ucd/PropertyAliases.txt#L19-L28
   */
  short_name: string;
   ...
   *
   * @source https://ucdjs.dev/file-explorer/v/18.0.0/ucd/PropertyAliases.txt#L19-L30
   */
