 ...
 * @generated 2026-04-28T04:39:00.042Z
 */
export interface Blocks {
  /**
   * Start Code of the Unicode block range in hexadecimal notation.
   *
  ...
  /**
   * End Code of the Unicode block range in hexadecimal notation.
   *
   * @source https://ucdjs.dev/file-explorer/v/18.0.0/ucd/Blocks.txt#L11
   */
  end_code: string;
