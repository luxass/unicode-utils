...
export interface Unihan31 {
   ...
   *
   * @source https://ucdjs.dev/file-explorer/v/3.1-Update/Unihan-3.1.txt#L33
   */
  tag: string;
   ...
   *
   * @source https://ucdjs.dev/file-explorer/v/3.1-Update/Unihan-3.1.txt#L34
   */
  value: string;
}
