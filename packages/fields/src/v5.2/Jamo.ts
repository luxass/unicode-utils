 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/5.2.0/ucd/Jamo.txt#L16-L20
 *
 * @unicodeVersion 5.2
 * @fields 2
 * @confidence 0.80
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-24T04:33:24.397Z
 */
export interface Jamo {
  /**
   * Code point in 4-digit hexadecimal form of a combining jamo character.
   *
   * @source https://ucdjs.dev/file-explorer/v/5.2.0/ucd/Jamo.txt#L16-L20
   */
  code_point: string;
