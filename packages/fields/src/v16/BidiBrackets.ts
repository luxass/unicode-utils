 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/16.0.0/ucd/BidiBrackets.txt#L48-L52
 *
 * @unicodeVersion 16
 * @fields 3
 * @confidence 0.90
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-24T04:14:10.168Z
 */
export interface BidiBrackets {
   ...
   *
   * @source https://ucdjs.dev/file-explorer/v/16.0.0/ucd/BidiBrackets.txt#L48-L52
   */
