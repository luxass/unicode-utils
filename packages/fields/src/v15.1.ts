...
// Generated At: 2026-04-23T16:39:28.871Z
// Files: 53
//   - ArabicShaping.txt
 ...
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/ArabicShaping.txt#L51
 *
 * @unicodeVersion 15.1
 * @fields 4
 * @confidence 1.00
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:37:14.665Z
 */
export interface ArabicShaping {
   ...
   *
   * @source https://ucdjs.dev/file-explorer/v/15.1.0/ucd/ArabicShaping.txt#L51
   */
 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/auxiliary/GraphemeBreakProperty.txt#L14
 ...
 * @confidence 0.80
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:37:17.894Z
 */
 ...
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/auxiliary/SentenceBreakProperty.txt#L12-L17
 *
 * @unicodeVersion 15.1
 * @fields 2
 * @confidence 0.80
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:37:19.803Z
 */
export interface AuxiliarySentenceBreakProperty {
   ...
   *
   * @source https://ucdjs.dev/file-explorer/v/15.1.0/ucd/auxiliary/SentenceBreakProperty.txt#L12-L17
   */
 ...
 * @confidence 0.80
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:37:20.908Z
 */
 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/BidiBrackets.txt#L49
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/BidiBrackets.txt#L50
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/BidiBrackets.txt#L51-L54
 *
 * @unicodeVersion 15.1
 * @fields 3
 * @confidence 1.00
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:37:15.615Z
 */
 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/BidiMirroring.txt#L14-L28
 *
 * @unicodeVersion 15.1
 * @fields 2
 * @confidence 0.80
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:37:20.690Z
 */
export interface BidiMirroring {
   ...
   *
   * @source https://ucdjs.dev/file-explorer/v/15.1.0/ucd/BidiMirroring.txt#L14-L28
   */
 ...
 * @confidence 0.90
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:37:18.562Z
 */
 ...
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/CaseFolding.txt#L36-L54
 *
 * @unicodeVersion 15.1
 * @fields 4
 * @confidence 0.90
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:37:18.256Z
 */
export interface CaseFolding {
   ...
   *
   * @source https://ucdjs.dev/file-explorer/v/15.1.0/ucd/CaseFolding.txt#L36-L54
   */
  status: "C" | "F" | "S" | "T";
 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/CJKRadicals.txt#L17-L19
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/CJKRadicals.txt#L17-L21
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/CJKRadicals.txt#L17-L22
 *
 * @unicodeVersion 15.1
 * @fields 3
 * @confidence 1.00
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:37:28.598Z
 */
export interface CjkRadicals {
  /**
   * CJK radical number matching the regular expression [1-9][0-9]{0,2}'{0,2}.
   *
   * @source https://ucdjs.dev/file-explorer/v/15.1.0/ucd/CJKRadicals.txt#L17-L19
   */
   ...
   *
   * @source https://ucdjs.dev/file-explorer/v/15.1.0/ucd/CJKRadicals.txt#L17-L22
   */
 ...
 * @confidence 0.80
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:37:30.124Z
 */
export interface CompositionExclusions {
  /**
   * Unicode code point of a character that is a primary composition exclusion.
   *
 ...
 * @confidence 0.80
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:37:33.903Z
 */
export interface DerivedAge {
   ...
   */
  age: "V1_1" | "V1_1_5" | "V2_0" | "V2_1" | "V3_0" | "V3_1" | "V3_2" | "V4_0" | "V4_1" | "V5_0" | "V5_1" | "V5_2" | "V6_0" | "V6_1" | "V6_2" | "V6_3" | "V7_0" | "V8_0" | "V9_0" | "V10_0" | "V11_0" | "V12_0" | "V12_1" | "V13_0" | "V14_0" | "V15_0" | "V15_1" | (string & {});
}
 ...
 * @confidence 0.70
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:37:35.083Z
 */
 ...
 * @generated 2026-04-23T16:38:07.565Z
 */
export interface DerivedNormalizationProps {
  /**
   * Source code point in the FC_NFKC_Closure mapping.
   *
   * @source https://ucdjs.dev/reports/tr44/
   */
  ...
  /**
   * List of target code points constituting the FC_NFKC_Closure.
   *
   * @source https://ucdjs.dev/reports/tr44/
   */
  closure_codepoints: Array<string>;
}

export const DERIVED_NORMALIZATION_PROPS_FIELDS = ["source_codepoint", "closure_codepoints"];
 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/EastAsianWidth.txt#L16
 ...
 * @confidence 1.00
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:37:32.032Z
 */
 ...
 * @confidence 0.90
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:37:29.776Z
 */
 ...
 * @confidence 0.70
 * @model grok-4-1-fast-reasoning
 * @generated 2026-04-23T16:38:22.217Z
 */
export interface EmojiEmojiVariationSequences {
  /**
   * Base Unicode code point that forms an emoji variation sequence.
   *
  ...
  /**
   * Variation selector sequence (e.g. FE0F) for emoji presentation.
   *
   * @source https://ucdjs.dev/reports/tr51/
   */
...
export const EMOJI_EMOJI_VARIATION_SEQUENCES_FIELDS = ["code_point", "variation_sequence"];
 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/EmojiSources.txt#L22
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/EmojiSources.txt#L23
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/EmojiSources.txt#L24
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/EmojiSources.txt#L25
 *
 * @unicodeVersion 15.1
 * @fields 4
 * @confidence 1.00
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:37:42.178Z
 */
 ...
 * @confidence 0.80
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:37:47.823Z
 */
...
export const EQUIVALENT_UNIFIED_IDEOGRAPH_FIELDS = ["source", "equivalent_unified_ideograph"];
 ...
 * @confidence 0.80
 * @model grok-4-1-fast-reasoning
 * @generated 2026-04-23T16:38:58.244Z
 */
export interface ExtractedDerivedBidiClass {
  /**
   * Unicode code point or range as documented for UCD property files.
   *
   * @source https://ucdjs.dev/reports/tr44/
   */
  code_point: string;
  ...
  /**
   * Bidi_Class property value (uses long canonical names such as Left_To_Right, Right_To_Left).
   *
   * @source https://ucdjs.dev/reports/tr44/
   */
  bidi_class: string;
 ...
 * @confidence 0.80
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:38:04.083Z
 */
 ...
 * @confidence 0.80
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:38:29.769Z
 */
 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/extracted/DerivedDecompositionType.txt#L12
 *
 * @unicodeVersion 15.1
 * @fields 2
 * @confidence 0.80
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:37:57.551Z
 */
export interface ExtractedDerivedDecompositionType {
   ...
   * @source https://ucdjs.dev/file-explorer/v/15.1.0/ucd/extracted/DerivedDecompositionType.txt#L12
   */
  decomposition_type: "Can" | "Com" | "Font" | "NoBreak" | "NB" | "Square" | "None";
}
 ...
 * @confidence 0.80
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:37:46.669Z
 */
 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/extracted/DerivedGeneralCategory.txt#L16
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/extracted/DerivedGeneralCategory.txt#L12
 *
 * @unicodeVersion 15.1
 * @fields 2
 * @confidence 0.80
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:38:40.165Z
 */
export interface ExtractedDerivedGeneralCategory {
  /**
   * Unicode code point range for characters with General_Category=Unassigned.
   *
   * @source https://ucdjs.dev/file-explorer/v/15.1.0/ucd/extracted/DerivedGeneralCategory.txt#L16
   */
  code_point_range: string;
   ...
   *
   * @source https://ucdjs.dev/file-explorer/v/15.1.0/ucd/extracted/DerivedGeneralCategory.txt#L12
   */
 ...
 * @confidence 0.70
 * @model grok-4-1-fast-reasoning
 * @generated 2026-04-23T16:38:59.795Z
 */
export interface ExtractedDerivedJoiningGroup {
  /**
   * Unicode code point or range with a specific Joining_Group.
   *
   * @source https://ucdjs.dev/reports/tr44/
   */
  code_point: string;
  ...
  /**
   * Joining_Group property value (non-default).
   *
   * @source https://ucdjs.dev/reports/tr44/
   */
  joining_group: string;
 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/extracted/DerivedJoiningType.txt#L17
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/extracted/DerivedJoiningType.txt#L12-L15
 *
 * @unicodeVersion 15.1
 * @fields 2
 * @confidence 0.80
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:38:17.570Z
 */
export interface ExtractedDerivedJoiningType {
   ...
   *
   * @source https://ucdjs.dev/file-explorer/v/15.1.0/ucd/extracted/DerivedJoiningType.txt#L17
   */
  code_point_range: string;

  /**
   * Derived Joining_Type value for explicitly listed code points (default is Non_Joining for all others).
   *
   * @source https://ucdjs.dev/file-explorer/v/15.1.0/ucd/extracted/DerivedJoiningType.txt#L12-L15
   */
 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/extracted/DerivedLineBreak.txt#L14-L15
 *
 * @unicodeVersion 15.1
 * @fields 1
 * @confidence 0.80
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:39:08.927Z
 */
export interface ExtractedDerivedLineBreak {
  /**
   * All code points not explicitly listed for Line_Break have the value Unknown (XX).
   *
   * @source https://ucdjs.dev/file-explorer/v/15.1.0/ucd/extracted/DerivedLineBreak.txt#L14-L15
   */
  line_break: "Unknown";
}

export const EXTRACTED_DERIVED_LINE_BREAK_FIELDS = ["line_break"];
 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/extracted/DerivedName.txt#L22
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/extracted/DerivedName.txt#L23
 *
 * @unicodeVersion 15.1
 * @fields 2
 * @confidence 1.00
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:38:23.961Z
 */
export interface ExtractedDerivedName {
  /**
   * Unicode code point value or range of code point values.
   *
   * @source https://ucdjs.dev/file-explorer/v/15.1.0/ucd/extracted/DerivedName.txt#L22
   */
 ...
 * @confidence 0.80
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:38:46.699Z
 */
 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/extracted/DerivedNumericValues.txt#L13-L19
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/extracted/DerivedNumericValues.txt#L20-L21
 ...
 * @confidence 1.00
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:38:18.995Z
 */
 ...
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/HangulSyllableType.txt#L12
 *
 * @unicodeVersion 15.1
 * @fields 2
 * @confidence 0.80
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:38:15.876Z
 */
export interface HangulSyllableType {
   ...
   *
   * @source https://ucdjs.dev/file-explorer/v/15.1.0/ucd/HangulSyllableType.txt#L12
   */
 ...
 * @confidence 0.00
 * @model grok-4-1-fast-reasoning
 * @generated 2026-04-23T16:39:06.521Z
 */
 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/IndicPositionalCategory.txt#L57
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/IndicPositionalCategory.txt#L58
 *
 * @unicodeVersion 15.1
 * @fields 2
 * @confidence 1.00
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:39:10.281Z
 */
 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/IndicSyllabicCategory.txt#L27
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/IndicSyllabicCategory.txt#L28
 *
 * @unicodeVersion 15.1
 * @fields 2
 * @confidence 1.00
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:38:35.243Z
 */
 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/Jamo.txt#L16-L18
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/Jamo.txt#L19-L21
 *
 * @unicodeVersion 15.1
 * @fields 2
 * @confidence 0.80
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:39:16.687Z
 */
 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/LineBreak.txt#L16
 ...
 * @confidence 1.00
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:38:43.079Z
 */
export interface LineBreak {
   ...
   *
   * @source https://ucdjs.dev/file-explorer/v/15.1.0/ucd/LineBreak.txt#L15-L24
   */
 ...
 * @confidence 0.90
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:38:35.890Z
 */
 ...
 * @confidence 0.90
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:38:33.365Z
 */
 ...
 * @confidence 0.00
 * @model grok-4-1-fast-reasoning
 * @generated 2026-04-23T16:39:17.524Z
 */
 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/NormalizationCorrections.txt#L35
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/NormalizationCorrections.txt#L36
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/NormalizationCorrections.txt#L37
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/NormalizationCorrections.txt#L38-L39
 *
 * @unicodeVersion 15.1
 * @fields 4
 * @confidence 1.00
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:39:14.774Z
 */
 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/NushuSources.txt#L17
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/NushuSources.txt#L18
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/NushuSources.txt#L19
 *
 * @unicodeVersion 15.1
 * @fields 3
 * @confidence 0.90
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:38:51.149Z
 */
 ...
 * @confidence 0.80
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:39:23.229Z
 */
 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/PropertyValueAliases.txt#L22
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/PropertyValueAliases.txt#L25
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/PropertyValueAliases.txt#L29
 *
 * @unicodeVersion 15.1
 * @fields 3
 * @confidence 0.80
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:38:57.250Z
 */
export interface PropertyValueAliases {
  /**
   * The property for which the property value name is used.
   *
   * @source https://ucdjs.dev/file-explorer/v/15.1.0/ucd/PropertyValueAliases.txt#L22
   */
  property: string;
   ...
   *
   * @source https://ucdjs.dev/file-explorer/v/15.1.0/ucd/PropertyValueAliases.txt#L25
   */
  short_name: string;
   ...
   *
   * @source https://ucdjs.dev/file-explorer/v/15.1.0/ucd/PropertyValueAliases.txt#L29
   */
  long_name: string;
}
 ...
 * @confidence 0.70
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:39:12.139Z
 */
 ...
 * @confidence 0.80
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:38:55.610Z
 */
 ...
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/Scripts.txt#L18-L23
 *
 * @unicodeVersion 15.1
 * @fields 2
 * @confidence 0.80
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:38:50.954Z
 */
export interface Scripts {
   ...
   *
   * @source https://ucdjs.dev/file-explorer/v/15.1.0/ucd/Scripts.txt#L18-L23
   */
  script: "Zzzz" | (string & {});
}
 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/SpecialCasing.txt#L32
 *
 * @unicodeVersion 15.1
 * @fields 6
 * @confidence 0.90
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:39:23.610Z
 */
 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/StandardizedVariants.txt#L38
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/StandardizedVariants.txt#L39
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/StandardizedVariants.txt#L40-L42
 *
 * @unicodeVersion 15.1
 * @fields 3
 * @confidence 1.00
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:39:17.726Z
 */
 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/TangutSources.txt#L21
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/TangutSources.txt#L22-L33
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/TangutSources.txt#L23
 *
 * @unicodeVersion 15.1
 * @fields 3
 * @confidence 0.90
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:39:03.982Z
 */
 ...
 * @confidence 0.00
 * @model grok-4-1-fast-reasoning
 * @generated 2026-04-23T16:39:28.871Z
 */
 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/USourceData.txt#L12
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/USourceData.txt#L13-L30
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/USourceData.txt#L31
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/USourceData.txt#L32
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/USourceData.txt#L33
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/USourceData.txt#L34
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/USourceData.txt#L35
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/USourceData.txt#L36
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/USourceData.txt#L37
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/USourceData.txt#L38
 *
 * @unicodeVersion 15.1
 * @fields 10
 * @confidence 1.00
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:39:09.489Z
 */
 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/VerticalOrientation.txt#L16-L17
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/VerticalOrientation.txt#L18-L22
 *
 * @unicodeVersion 15.1
 * @fields 2
 * @confidence 0.90
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T16:39:17.756Z
 */
