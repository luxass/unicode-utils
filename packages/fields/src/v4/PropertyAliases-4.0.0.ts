 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/4.0-Update/PropertyAliases-4.0.0.txt#L16-L19
 *
 * @unicodeVersion 4
 * @fields 2
 * @confidence 0.90
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T18:54:24.246Z
 */
export interface PropertyAliases400 {
   ...
   *
   * @source https://ucdjs.dev/file-explorer/v/4.0-Update/PropertyAliases-4.0.0.txt#L18-L19
   */
  long_name: string;
}
