 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/15.0.0/ucd/BidiMirroring.txt#L26-L29
 *
 * @unicodeVersion 15
 * @fields 3
 * @confidence 0.80
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-28T04:43:19.615Z
 */
export interface BidiMirroring {
   ...
   *
   * @source https://ucdjs.dev/file-explorer/v/15.0.0/ucd/BidiMirroring.txt#L29
   */
  comment: string;
}
