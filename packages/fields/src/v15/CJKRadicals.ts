 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/15.0.0/ucd/CJKRadicals.txt#L13-L22
 *
 * @unicodeVersion 15
 * @fields 3
 * @confidence 0.80
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T18:48:07.404Z
 */
export interface CjkRadicals {
   ...
   *
   * @source https://ucdjs.dev/file-explorer/v/15.0.0/ucd/CJKRadicals.txt#L13-L19
   */
