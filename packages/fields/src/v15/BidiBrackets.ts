 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/15.0.0/ucd/BidiBrackets.txt#L48-L54
 *
 * @unicodeVersion 15
 * @fields 3
 * @confidence 1.00
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T18:48:19.661Z
 */
export interface BidiBrackets {
   ...
   *
   * @source https://ucdjs.dev/file-explorer/v/15.0.0/ucd/BidiBrackets.txt#L48-L54
   */
