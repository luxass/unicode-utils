 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/10.0.0/ucd/BidiBrackets.txt#L48-L54
 *
 * @unicodeVersion 10
 * @fields 3
 * @confidence 0.90
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-24T04:20:48.355Z
 */
export interface BidiBrackets {
  /**
   * Unicode code point value, represented as a hexadecimal value.
   *
   * @source https://ucdjs.dev/file-explorer/v/10.0.0/ucd/BidiBrackets.txt#L48-L49
   */
  code_point: string;
   ...
   *
   * @source https://ucdjs.dev/file-explorer/v/10.0.0/ucd/BidiBrackets.txt#L48-L50
   */
   ...
   *
   * @source https://ucdjs.dev/file-explorer/v/10.0.0/ucd/BidiBrackets.txt#L48-L54
   */
