 ...
 * @generated 2026-04-28T04:42:30.298Z
 */
export interface USourceData {
  ...
  /**
   * Status of the ideograph: Comp=Encoded as a CJK Compatibility Ideograph, ExtA=Encoded in Extension A, etc., or (UTC-\d{5})|(UCI-\d{5}) for deprecated duplicates.
   *
