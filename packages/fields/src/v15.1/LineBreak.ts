 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/15.1.0/ucd/LineBreak.txt#L15-L24
 *
 * @unicodeVersion 15.1
 * @fields 2
 * @confidence 0.90
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-28T04:41:37.035Z
 */
export interface LineBreak {
  /**
   * Unicode code point value or range of code point values.
   *
   * @source https://ucdjs.dev/file-explorer/v/15.1.0/ucd/LineBreak.txt#L15-L17
   */
  codepoints: string;
   ...
   *
   * @source https://ucdjs.dev/file-explorer/v/15.1.0/ucd/LineBreak.txt#L17-L24
   */
