 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/6.2.0/ucd/USourceData.txt#L13-L32
 *
 * @unicodeVersion 6.2
 * @fields 7
 * @confidence 1.00
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-24T04:26:29.071Z
 */
export interface USourceData {
  /**
   * The U-source ID
   *
   * @source https://ucdjs.dev/file-explorer/v/6.2.0/ucd/USourceData.txt#L13
   */
  u_source_id: string;
   ...
   *
   * @source https://ucdjs.dev/file-explorer/v/6.2.0/ucd/USourceData.txt#L14-L21
   */
   ...
   *
   * @source https://ucdjs.dev/file-explorer/v/6.2.0/ucd/USourceData.txt#L22-L28
   */
