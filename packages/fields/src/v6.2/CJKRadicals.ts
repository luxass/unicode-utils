 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/6.2.0/ucd/CJKRadicals.txt#L18-L22
 *
 * @unicodeVersion 6.2
 * @fields 3
 * @confidence 1.00
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-24T04:24:52.776Z
 */
export interface CjkRadicals {
  /**
   * The radical number matching the regular expression [0-9]{1,3}'?.
   *
   * @source https://ucdjs.dev/file-explorer/v/6.2.0/ucd/CJKRadicals.txt#L18-L22
   */
   ...
   *
   * @source https://ucdjs.dev/file-explorer/v/6.2.0/ucd/CJKRadicals.txt#L19-L20
   */
   ...
   *
   * @source https://ucdjs.dev/file-explorer/v/6.2.0/ucd/CJKRadicals.txt#L20
   */
