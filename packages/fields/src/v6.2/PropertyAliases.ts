 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/6.2.0/ucd/PropertyAliases.txt#L18-L24
 *
 * @unicodeVersion 6.2
 * @fields 3
 * @confidence 0.90
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-28T04:51:26.695Z
 */
export interface PropertyAliases {
  /**
   * The first field is an abbreviated name for the property.
   *
   * @source https://ucdjs.dev/file-explorer/v/6.2.0/ucd/PropertyAliases.txt#L18-L20
   */
   ...
   *
   * @source https://ucdjs.dev/file-explorer/v/6.2.0/ucd/PropertyAliases.txt#L18-L22
   */
  long_name: string;
   ...
   *
   * @source https://ucdjs.dev/file-explorer/v/6.2.0/ucd/PropertyAliases.txt#L18-L24
   */
