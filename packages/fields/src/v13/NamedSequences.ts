 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/13.0.0/ucd/NamedSequences.txt#L14-L15
 *
 * @unicodeVersion 13
 * @fields 2
 * @confidence 0.90
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-28T04:45:33.106Z
 */
export interface NamedSequences {
  /**
   * Name of Sequence
   *
   * @source https://ucdjs.dev/file-explorer/v/13.0.0/ucd/NamedSequences.txt#L14-L15
   */
  name: string;
