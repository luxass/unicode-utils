 ...
 * @generated 2026-04-28T04:45:41.484Z
 */
export interface USourceData {
  ...
  /**
   * Text indicating the ideograph's status with possible values A=Encoded in Extension A, B=Encoded in Extension B, C=Encoded in Extension C, Comp=Encoded as a compatibility ideograph, D=Encoded in Extension D, E=Encoded in Extension E, F=Encoded in Extension F, G=Encoded in Extension G, N=Planned to be submitted for a future extension, U=Encoded in the URO or as a unified ideograph in the CJK Compatibility Ideographs block, UK-2015=Submitted by the UK for IRG Working Set 2015, V=Variant of an encoded character, W=Not suitable for encoding as a CJK Unified Ideograph, WS-2017=Submitted by the UTC for IRG Working Set 2017, X=No action taken, or (UTC-\d{5})|(UCI-\d{5})=Duplicate entries deprecated in favor of other entries.
   *
