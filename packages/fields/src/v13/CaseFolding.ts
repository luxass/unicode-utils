 ...
 * - https://ucdjs.dev/file-explorer/v/13.0.0/ucd/CaseFolding.txt#L38-L43
 *
 * @unicodeVersion 13
 * @fields 4
 * @confidence 0.90
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T18:50:00.575Z
 */
export interface CaseFolding {
   ...
   *
   * @source https://ucdjs.dev/file-explorer/v/13.0.0/ucd/CaseFolding.txt#L38-L43
   */
  status: "C" | "F" | "S" | "T";
