 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/6.0.0/ucd/CJKRadicals.txt#L13-L23
 *
 * @unicodeVersion 6
 * @fields 3
 * @confidence 0.90
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-28T04:52:36.692Z
 */
export interface CjkRadicals {
  /**
   * The radical number used in the kRSUnicode property, matching [0-9]{1,3}'?.
   *
   * @source https://ucdjs.dev/file-explorer/v/6.0.0/ucd/CJKRadicals.txt#L17-L23
   */
