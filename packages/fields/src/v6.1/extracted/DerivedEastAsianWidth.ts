 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/6.1.0/ucd/extracted/DerivedEastAsianWidth.txt#L11
 * - https://ucdjs.dev/file-explorer/v/6.1.0/ucd/extracted/DerivedEastAsianWidth.txt#L20
 *
 * @unicodeVersion 6.1
 * @fields 2
 * @confidence 0.80
