 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/11.0.0/ucd/Jamo.txt#L14-L21
 *
 * @unicodeVersion 11
 * @fields 2
 * @confidence 0.80
 * @model grok-4-1-fast-non-reasoning
 * @generated 2026-04-23T18:51:06.031Z
 */
export interface Jamo {
  /**
   * Code point in 4-digit hexadecimal form of a conjoining jamo character.
   *
   * @source https://ucdjs.dev/file-explorer/v/11.0.0/ucd/Jamo.txt#L14-L21
   */
  code_point: string;
