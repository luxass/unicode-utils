 ...
 *
 * Fields derived from:
 * - https://ucdjs.dev/file-explorer/v/10.0.0/ucd/PropertyValueAliases.txt#L22
 * - https://ucdjs.dev/file-explorer/v/10.0.0/ucd/PropertyValueAliases.txt#L25
 ...
 * @generated 2026-04-23T18:52:32.180Z
 */
export interface PropertyValueAliases {
  /**
   * The property for which the property value name is used.
   *
   * @source https://ucdjs.dev/file-explorer/v/10.0.0/ucd/PropertyValueAliases.txt#L22
   */
  property: string;
